...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoVerificacion
    {
        private string nombre;
        private DataTable dataDocumento;
        private SqlDataAdapter adapterDocumento;

        public AgregarDocumentoVerificacion()
        {
            InitializeComponent();
        }
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.DatosVerificacion.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
