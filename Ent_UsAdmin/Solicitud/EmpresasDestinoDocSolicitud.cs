...
namespace ConfiaAdmin
{
    ...
    public partial class EmpresasDestinoDocSolicitud
    {
        ...
        public EmpresasDestinoDocSolicitud()
        {
            InitializeComponent();
        }
        ...
        private async void clickevenntAsync(object sender, EventArgs e)
        {
            ...
            if (Module1.usuarioActivo)
            {
                try
                {
                    ...
                    My.MyProject.Forms.TraspasarDocumentosSolicitud.ipDestino = Conversions.ToString(b.Tag);
                    // Save and encrypt the file.
                    // iniFile.Save("C:\Modulo\SetConfig.ini")
                    My.MyProject.Forms.TraspasarDocumentosSolicitud.bdDestino = Conversions.ToString(b.Name);
                    ...
                    if (conectado)
                    {
                        ...
                        My.MyProject.Forms.TraspasarDocumentosSolicitud.lblDestino.Text = Conversions.ToString(b.Text);

                        Close();
                    }
                    else
                    {
                        My.MyProject.Forms.TraspasarDocumentosSolicitud.lblDestino.Text = "No se pudo conectar";
                        My.MyProject.Forms.Cargando.Close();
                    }
                }
        ...
        private bool IntentaConexion()
        {
            ...
            try
            {
                ...
                string cnConexion;
                cnConexion = "Provider=sqloledb;" + "Data Source=  " + ipPrueba + @"\confia;" + "Initial Catalog=" + bdPrueba + ";" + "User Id=sa;Password=BSi5t3Ma$CFAD;";
