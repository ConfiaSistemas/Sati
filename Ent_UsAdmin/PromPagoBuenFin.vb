...
(select * from Empleados where Tipo = 'P') Promotores on Cartera.IdPromotor = Promotores.id ) CarteraTotal order by nombre asc"
        ...
        End If
        descuentoParcial = multasParcial * 0.9
...
(select * from Empleados where Tipo = 'P') Promotores on Cartera.IdPromotor = Promotores.id ) CarteraTotal order by nombre asc"
        ...
        End If
        descuentoTotal = multasTotal * 0.9
        ...
        lblDescuentoTotal.Text = descuentoTotal
    ...
    Private Sub BackgroundCrearPromesa_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundCrearPromesa.DoWork
        ...
        If CheckVencidos.CheckState = CheckState.Checked Then
            consultaCrearPromesa = "insert into PromesaDePago values('" & idCredito & "','" & totalParcial & "','" & pagonormalParcial & "','" & multasParcial & "','" & totalParcial & "',0,'" & dateFechaLimite.Value.ToString("yyyy-MM-dd") & "','','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "','" & nmusr & "','A','" & estadoCredito & "','" & totalParcial & "','" & descuentoParcial & "',0) SELECT SCOPE_IDENTITY()"
        Else
            consultaCrearPromesa = "insert into PromesaDePago values('" & idCredito & "','" & TotalTotal & "','" & pagoNormalTotal & "','" & multasTotal & "','" & TotalTotal & "',0,'" & dateFechaLimite.Value.ToString("yyyy-MM-dd") & "','','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "','" & nmusr & "','A','" & estadoCredito & "','" & TotalTotal & "','" & descuentoTotal & "',0) SELECT SCOPE_IDENTITY()"
        End If
...
"
    ...
    Private Sub BackgroundPromesaNotificacion_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundPromesaNotificacion.DoWork
        ...
        If CheckVencidos.CheckState = CheckState.Checked Then
            consultaCrearPromesa = "insert into PromesaDePago values('" & idCredito & "','" & totalParcial & "','" & pagonormalParcial & "','" & multasParcial & "','" & totalParcial & "',0,'" & dateFechaLimite.Value.ToString("yyyy-MM-dd") & "','','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "','" & nmusr & "','E','" & estadoCredito & "','" & totalParcial & "','" & descuentoParcial & "',0) SELECT SCOPE_IDENTITY()"
        Else
            consultaCrearPromesa = "insert into PromesaDePago values('" & idCredito & "','" & TotalTotal & "','" & pagoNormalTotal & "','" & multasTotal & "','" & TotalTotal & "',0,'" & dateFechaLimite.Value.ToString("yyyy-MM-dd") & "','','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "','" & nmusr & "','E','" & estadoCredito & "','" & TotalTotal & "','" & descuentoTotal & "',0) SELECT SCOPE_IDENTITY()"
        End If
    ...
    Private Sub BackgroundPromesaNotificacion_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundPromesaNotificacion.RunWorkerCompleted
        ncargando.Close()
        CrearNotificacionDescuentoBuenFin.idPromesa = idPromesa
        CrearNotificacionDescuentoBuenFin.tipoCredito = TipoCredito
        CrearNotificacionDescuentoBuenFin.ShowDialog()
