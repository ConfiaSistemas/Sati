...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoCredito
    {
        ...
        public AgregarDocumentoCredito()
        {
            InitializeComponent();
        }
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.DocumentosCredito.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
