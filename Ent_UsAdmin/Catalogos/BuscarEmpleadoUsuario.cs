...
namespace ConfiaAdmin
{
    ...
    public partial class BuscarEmpleadoUsuario
    {
        ...
        {
            My.MyProject.Forms.Agregar_Usuario.txtempleado.Text = Conversions.ToString(dtdatos.CurrentRow.Cells[0].Value);

            Invoke(new Action(() => My.MyProject.Forms.Agregar_Usuario.ConsultarEmpleado()));
            Close();
        }
    }
}