...
Public Class EmpresasOrigenDocSolicitud
    ...
    Private Async Sub clickevenntAsync(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If usuarioActivo Then
            Try
                ...
                TraspasarDocumentosSolicitud.ipOrigen = sender.tag
                ' Save and encrypt the file.
                ' iniFile.Save("C:\Modulo\SetConfig.ini")
                TraspasarDocumentosSolicitud.bdOrigen = sender.name
                ...
                If conectado Then
                    ...
                    Cargando.Close()
                    TraspasarDocumentosSolicitud.lblOrigen.Text = sender.text

                    Me.Close()
                Else
                    TraspasarDocumentosSolicitud.lblOrigen.Text = "No se pudo conectar"
                    Cargando.Close()
                End If
    ...
    Private Function IntentaConexion() As Boolean
        ...
        Try
            Dim IntentoConexion As SqlConnection
            Dim cnConexion As String
            cnConexion = "Data Source=  " & ipPrueba & "\confia;" &
