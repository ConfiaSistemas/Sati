...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoLegal
    {
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.DocumentosCreditoLegal.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
