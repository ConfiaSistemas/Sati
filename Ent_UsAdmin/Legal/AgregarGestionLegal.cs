...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarGestionLegal
    {
        public string idCredito;
        public string frmNombre;

        public AgregarGestionLegal()
        {
            InitializeComponent();
        }
        ...
        private void BackgroundGestion_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            consultaGestion = "insert into GestionesLegales values('" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + idCredito + "','" + txtConcepto.Text + "','" + Module1.nm_completeusr + "')";
        ...
        private void BackgroundGestion_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            foreach (Form frm in Application.OpenForms)
            {
                ...
                {
                    InformacionLegal frmn;
                    frmn = (InformacionLegal)frm;
