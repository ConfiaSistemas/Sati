...
Public Class AgregarDocumentoDatosSolicitud
    ...
    Private Sub btn_Procesar_Click(sender As Object, e As EventArgs) Handles btn_Procesar.Click
        ...
        Else
            ...
            DatosSolicitud.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image)
