    ...
    Public Sub ResizeForm(ObjForm As Form, DesignerWidth As Integer, DesignerHeight As Integer)
        ...
        For Each c As Control In ObjForm.Controls
            ...
            If (TypeOf (c) Is FlowLayoutPanel) Then
                For Each cr As Control In c.Controls
                    If cr.HasChildren Then
                        ResizeControlStore(cr)
                    Else
                        cr.Font = New Font(cr.Font.FontFamily, cr.Font.Size * f_HeightRatio, cr.Font.Style, cr.Font.Unit, (CByte(0)))
                    End If
                Next
            End If
        Next
