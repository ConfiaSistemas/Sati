...
namespace ConfiaAdmin
{
    ...
    public partial class ImprimirTerminal

    {
        ...
        {
            FileSystem.FileCopy(@"C:\ConfiaAdmin\SATI\Terminal.docx", @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempTerminal.docx");
            var documento = DocX.Load(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempTerminal.docx");
        ...
        private void BackgroundConvenio_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            consultaConvenio = "select ConveniosTerminalesSac.*,Credito.Nombre as nombreCredito,CONCAT(Clientes.Nombre,' ',Clientes.ApellidoPaterno,' ',Clientes.ApellidoMaterno) as nombre, CONCAT(DatosSolicitud.Calle,' ',DatosSolicitud.Noext,' ',DatosSolicitud.Colonia) as domicilio from ConveniosTerminalesSac inner join  Credito on ConveniosTerminalesSac.idCredito = Credito.id inner join Clientes on Credito.IdCliente = Clientes.id inner join DatosSolicitud on Credito.IdSolicitud = DatosSolicitud.IdSolicitud and Credito.IdCliente = DatosSolicitud.IdCliente where ConveniosTerminalesSac.idcredito = '" + idCredito + "'";
            ...
            consultaCalendario = "select format(Fechapago,'dd/MM/yyyy') as 'Fecha de pago',npago as 'Número de pago',format(monto+multas,'C','es-mx') as Monto from calendarioConveniosTerminalesSac where idconvenio = '" + idConvenio + "'";
        ...
        private void dataTableToWord(System.Data.DataTable dt)
        {
            ...
            FileSystem.FileCopy(@"C:\ConfiaAdmin\SATI\Calendario Terminal.docx", @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioTerminal.docx");
            object argFileName = @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioTerminal.docx";
        ...
        private void BackgroundImprimirCalendario_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            var documento = DocX.Load(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioTerminal.docx");
            documento.ReplaceText("%%FECHACONVENIO%%", FechaConvenio.ToString("dd/MM/yyyy"));
            ...
            spDoc.LoadFromFile(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioTerminal.docx");
        ...
        {
            var spDoc = new Spire.Doc.Document();
            spDoc.LoadFromFile(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempTerminal.docx");
