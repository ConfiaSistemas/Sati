        ...
        private void MonoFlat_Button2_Click(object sender, EventArgs e)
        {
            switch (tipoAutorizacion ?? "")
            {
                ...
                case "SatiModClientesModificar":
                    {
                        My.MyProject.Forms.ActualizarCliente.autorizado = false;
                        Close();
                        break;
                    }
                ...
                case "SacCancelarTicket":
                    {
                        My.MyProject.Forms.Reportes.CatTickets.autorizado = false;
                        Close();
                        break;
                    }
                ...
                case "SatiModCreditosModificar":
                    {
                        My.MyProject.Forms.CreditosAsociadosActualizarCliente.Autorizado = false;
                        Close();
                        break;
                    }
                case "SatiModCreditosCrearConvenioTerminal":
                    {
                        My.MyProject.Forms.CalendarioConvenioTerminal.Autorizado = false;
                        Close();
                        break;
                    }
                ...
                case "SatiModClientesModificar":
                    {
                        if (autorizado)
                        {
                            My.MyProject.Forms.ActualizarCliente.autorizado = true;
                            autorizado = false;
                            txtusr.MonoFlatTB.Text = "";
                            txtcontra.MonoFlatTB.Text = "";
                        }
                ...
                case "SacCancelarTicket":
                    {
                        if (autorizado)
                        {
                            My.MyProject.Forms.Reportes.CatTickets.autorizado = true;
                            autorizado = false;
                            txtusr.MonoFlatTB.Text = "";
                            txtcontra.MonoFlatTB.Text = "";
                        }
                        ...
                        {
                            My.MyProject.Forms.Tickets.autorizado = false;
                            autorizado = false;
                            txtusr.MonoFlatTB.Text = "";
                            txtcontra.MonoFlatTB.Text = "";
                        }
                ...
                case "SatiModCreditosModificar":
                    {
                        if (autorizado)
                        {
                            My.MyProject.Forms.CreditosAsociadosActualizarCliente.Autorizado = true;
                            autorizado = false;
                            txtusr.MonoFlatTB.Text = "";
                            txtcontra.MonoFlatTB.Text = "";
                        }
                ...
                case "SatiModCreditosCrearConvenioTerminal":
                    {
                        if (autorizado)
                        {
                            My.MyProject.Forms.CalendarioConvenioTerminal.Autorizado = true;
                            autorizado = false;
                            txtusr.MonoFlatTB.Text = "";
                            txtcontra.MonoFlatTB.Text = "";
                        }
