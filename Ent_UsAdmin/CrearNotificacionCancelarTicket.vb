...
Public Class CrearNotificacionCancelarTicket
    ...
    Private Sub BackgroundNotificacion_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundNotificacion.DoWork
        Try
            ...
            consultaLogin = "insert into Notificaciones values(null,'CancelarTicket',1,'" & nmusr & "','" & ComboUsuarios.selectedValue & "','" & idTicket & "','','" & txtComentario.Text & "',0,'0','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "',0,'','','" & nombreAmostrar & "','',''); "
