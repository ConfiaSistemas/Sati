...
Public Class ImprimirReestructura
    ...
    Private Sub BackgroundImprimirConvenio_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundImprimirConvenio.DoWork
        FileCopy("C:\ConfiaAdmin\SATI\Reestructura.docx", "C:\ConfiaAdmin\SATI\TEMPDOCS\TempReestructura.docx")
        Dim documento As DocX = DocX.Load("C:\ConfiaAdmin\SATI\TEMPDOCS\TempReestructura.docx")
    ...
    Private Sub dataTableToWord(ByVal dt As System.Data.DataTable)
        ...
        FileCopy("C:\ConfiaAdmin\SATI\Calendario Reestructura.docx", "C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioReestructura.docx")
        Doc = Word.Documents.Open("C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioReestructura.docx")
    ...
    Private Sub BackgroundImprimirCalendario_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundImprimirCalendario.RunWorkerCompleted
        ...
        Dim documento As DocX = DocX.Load("C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioReestructura.docx")
        documento.ReplaceText("%%FECHACONVENIO%%", FechaConvenio.ToString("dd/MM/yyyy"))
