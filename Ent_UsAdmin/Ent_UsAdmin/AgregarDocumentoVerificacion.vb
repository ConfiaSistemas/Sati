...
Public Class AgregarDocumentoVerificacion
    ...
    Private Sub btn_Procesar_Click(sender As Object, e As EventArgs) Handles btn_Procesar.Click
        ...
        Else
            ...
            DatosVerificacion.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image)
