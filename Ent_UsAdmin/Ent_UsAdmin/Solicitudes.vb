    ...
    Public Sub cargarSolicitudes()
        ...
        Dim strimpuestos As String
            ...
            If EmpleadoAsignado <> 0 Then
                ...
                strimpuestos = "select id,nombre,fecha,monto,estado,tipo, from Solicitud inner join tipo where idpromotor = '" & EmpleadoAsignado & "' or idgestor = '" & EmpleadoAsignado & "'"
            Else
                strimpuestos = "select id,nombre,fecha,monto,estado,tipo from Solicitud"
            End If
