...
Public Class PagosHoy
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        consultaPagos = "select calendarionormal.id_credito,credito.nombre,calendarionormal.monto,calendarionormal.interes,calendarionormal.abonado,calendarionormal.pendiente,calendarionormal.Npago,( case when calendarionormal.Abonado < (calendarionormal.Pendiente + calendarionormal.monto) and calendarionormal.abonado > 0 then 
'Abonado'
when Abonado = 0 then
'Sin pagar'
else
...
END 
 ...
 from calendarionormal inner join credito on calendarionormal.id_credito = credito.id where calendarionormal.fechapago >= '" & Now.Date.ToString("yyyy-MM-dd") & "' and calendarionormal.fechapago <= '" & Now.Date.ToString("yyyy-MM-dd") & "'"
