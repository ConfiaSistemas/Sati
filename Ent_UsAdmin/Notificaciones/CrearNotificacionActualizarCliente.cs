...
namespace ConfiaAdmin
{
    ...
    public partial class CrearNotificacionActualizarCliente
    {
        ...
        public CrearNotificacionActualizarCliente()
        {
            InitializeComponent();
        }
        ...
        {
            creada = false;
            lblActualizacion.Text = idActualizacion;
        ...
        private void BackgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            consulta = "select Usr.nm,Usr.nm_complete from Usr inner join grp on Usr.grp = grp.id inner join PermisosGrupo on grp.id = PermisosGrupo.idGrupo where PermisosGrupo.SatiModCreditosModificar = 1";
        ...
        private void BackgroundNotificacion_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                consultaLogin = "insert into Notificaciones values(null,'ActualizarCliente',1,'" + Module1.nmusr + "','" + ComboUsuarios.selectedValue + "','" + idActualizacion + "','','" + txtComentario.Text + "',0,'0','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("HH:mm:ss") + "',0,'','','" + Module1.nombreAmostrar + "','',''); ";
        ...
        private void BackgroundNotificacion_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (creada)
            {
                ...
                nCargando.Close();
                My.MyProject.Forms.CreditosAsociadosActualizarCliente.creada = true;
                Close();
            }
            else
            {
        ...
        private void CrearNotificacionDescuentoPromesa_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                My.MyProject.Forms.CreditosAsociadosActualizarCliente.creada = false;
