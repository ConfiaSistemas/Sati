...
namespace ConfiaAdmin
{
    ...
    public partial class AutorizacionNotificacionBuenFin
    {
        ...
        public AutorizacionNotificacionBuenFin()
        {
            InitializeComponent();
        }
        ...
        private void MonoFlat_Button2_Click(object sender, EventArgs e)
        {
            switch (tipoAutorizacion ?? "")
            {
                ...
                case "SatiModCreditosDescuentoPromesa":
                    {
                        My.MyProject.Forms.AplicarDescuentoBuenFin.Autorizado = false;
                        Close();
                        break;
                    }
                ...
                case "SatiModCreditosDescuentoPromesa":
                    {
                        if (autorizado)
                        {
                            My.MyProject.Forms.AplicarDescuentoBuenFin.Autorizado = true;
                            autorizado = false;
