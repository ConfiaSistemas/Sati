...
{
    public partial class ImportarExcelTraspaso
    {
        public ImportarExcelTraspaso()
        {
            InitializeComponent();
        }
        ...
        {
            My.MyProject.Forms.TraspasarDocumentosSolicitud.fila = txtfila.Text;
            My.MyProject.Forms.TraspasarDocumentosSolicitud.columna = Combocodigo.Text;
            Close();
        }
