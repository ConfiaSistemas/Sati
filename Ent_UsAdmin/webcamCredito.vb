...
Public Class webcamCredito
    ...
    Private Sub btn_capturar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_capturar.Click
        EntregarDocumentacion.BunifuImageButton1.Image = VideoSourcePlayer1.GetCurrentVideoFrame
        EntregarDocumentacion.labelimagen.Visible = False
    End Sub
