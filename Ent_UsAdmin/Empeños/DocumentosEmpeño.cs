...
namespace ConfiaAdmin
{
    ...
    public partial class DocumentosEmpeño
    {
        public string idEmpeño;

        public DocumentosEmpeño()
        {
            InitializeComponent();
        }
        private void btn_agregar_Click(object sender, EventArgs e)
        {
            My.MyProject.Forms.AgregarDocumentoEmpeño.ShowDialog();
        }
        ...
        private void BackgroundDocumentos_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dtdatosDocumentosNuevos.Rows)
            {
                ...
                consultaDocumento = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("insert into DocumentosEmpeño values('" + idEmpeño + "','", row.Cells[0].Value), "',@Documento)"));
        ...
        private void BackgroundDocumentos_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            Invoke(new Action(() => My.MyProject.Forms.InformacionEmpeño.BackgroundArticulos.RunWorkerAsync()));
