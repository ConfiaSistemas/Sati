...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoEmpeño
    {
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.DocumentosEmpeño.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
