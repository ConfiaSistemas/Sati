...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoDatosSolicitudBoleta
    {
        ...
        public AgregarDocumentoDatosSolicitudBoleta()
        {
            InitializeComponent();
        }
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.DatosSolicitudBoleta.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
