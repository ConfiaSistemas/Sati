...
Public Class AplicarDescuentoBuenFin
    ...
    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles BunifuThinButton21.Click
        AutorizacionNotificacionBuenFin.tipoAutorizacion = "SatiModCreditosDescuentoPromesa"
        AutorizacionNotificacionBuenFin.ShowDialog()
        If Autorizado Then
        ...
        If estadoNotificacion = "A" Then
            If conectado Then
                ...
                For Each row As DataGridViewRow In dtDetalle.Rows
                    ...
                    Select Case row.Cells(12).Value
                        Case "C"
                    ...
                    Dim ComandoAplicarDescuento As SqlCommand
                    Dim consultaAplicarDescuento As String
                    ...
                    ComandoAplicarDescuento.Parameters.AddWithValue("Usuario", nmusr)
                    If row.Cells(12).Value = "L" Then
