...
Public Class webcamEmpeño
    ...
    Private Sub btn_capturar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_capturar.Click
        EntregarDocumentacionEmpeño.BunifuImageButton1.Image = VideoSourcePlayer1.GetCurrentVideoFrame
        EntregarDocumentacionEmpeño.labelimagen.Visible = False
    End Sub
