...
namespace ConfiaAdmin
{
    ...
    public partial class AgregarDocumentoMotocicleta
    {
        ...
        public AgregarDocumentoMotocicleta()
        {
            InitializeComponent();
        }
        ...
        private void btn_Procesar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                My.MyProject.Forms.CaputarMotocicleta.dtdatosDocumentosNuevos.Rows.Add(idTipoDocumento, ComboDocumento.Text, BunifuImageButton1.Image);
