...
namespace ConfiaAdmin
{
    ...
    public partial class CalendarioConvenio
    {
        ...
        private void BackgroundConvenio_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            int idConvenio;
            consultaConvenio = "insert into ConveniosSac values('" + idCredito + "','" + cantPagos + "','" + Moratorios + "','" + Capital + "','" + deudaTotal + "','" + pagoprimero + "','" + ultimopago + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + gestor + "','A') select SCOPE_IDENTITY()";
            ...
            foreach (DataGridViewRow row in dtimpuestos.Rows)
            {
                ...
                consultaCalendario = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("Insert into calendarioConveniosSac values('" + numero + "','", row.Cells[2].Value), "','"), row.Cells[1].Value), "','0','"), row.Cells[0].Value), "','','"), idConvenio), "','P','"), row.Cells[3].Value), "','0','"), row.Cells[3].Value), "')"));
        ...
        {
            My.MyProject.Forms.Autorizacion.tipoAutorizacion = "SatiModCreditosCrearConvenio";
