...
namespace ConfiaAdmin
{
    ...
    public partial class ImprimirConvenio
    {
        ...
        {
            FileSystem.FileCopy(@"C:\ConfiaAdmin\SATI\Convenio.docx", @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempConvenio.docx");
            var documento = DocX.Load(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempConvenio.docx");
        ...
        private void dataTableToWord(System.Data.DataTable dt)
        {
            ...
            FileSystem.FileCopy(@"C:\ConfiaAdmin\SATI\Calendario Convenio.docx", @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioConvenio.docx");
            object argFileName = @"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioConvenio.docx";
        ...
        private void BackgroundImprimirCalendario_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            var documento = DocX.Load(@"C:\ConfiaAdmin\SATI\TEMPDOCS\TempCalendarioConvenio.docx");
            documento.ReplaceText("%%FECHACONVENIO%%", FechaConvenio.ToString("dd/MM/yyyy"));
