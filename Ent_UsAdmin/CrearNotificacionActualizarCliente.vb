...
Public Class CrearNotificacionActualizarCliente

    Public idActualizacion As String
    ...
    Private Sub BackgroundNotificacion_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundNotificacion.DoWork
        Try
            ...
            consultaLogin = "insert into Notificaciones values(null,'ActualizarCliente',1,'" & nmusr & "','" & ComboUsuarios.selectedValue & "','" & idActualizacion & "','','" & txtComentario.Text & "',0,'0','" & Date.Now.ToString("yyyy-MM-dd") & "','" & Date.Now.ToString("HH:mm:ss") & "',0,'','','" & nombreAmostrar & "','',''); "
    ...
    Private Sub BackgroundNotificacion_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundNotificacion.RunWorkerCompleted
        If creada Then
            ...
            nCargando.Close()
            CreditosAsociadosActualizarCliente.creada = True
            Me.Close()
        Else
    ...
    Private Sub CrearNotificacionDescuentoPromesa_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ...
        Else
            CreditosAsociadosActualizarCliente.creada = False
