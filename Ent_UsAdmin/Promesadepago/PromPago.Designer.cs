...
namespace ConfiaAdmin
{
    ...
    public partial class PromPago : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            DataGridViewCellStyle4.BackColor = Color.FromArgb(158, 185, 220);
            dtVencidos.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle4;
            ...
            DataGridViewCellStyle5.BackColor = Color.FromArgb(191, 219, 255);
            DataGridViewCellStyle5.Font = new Font("Segoe UI", 8.25f);
            DataGridViewCellStyle5.ForeColor = Color.FromArgb(21, 66, 139);
            DataGridViewCellStyle5.SelectionBackColor = SystemColors.Highlight;
            DataGridViewCellStyle5.SelectionForeColor = SystemColors.HighlightText;
            DataGridViewCellStyle5.WrapMode = DataGridViewTriState.True;
            dtVencidos.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle5;
            dtVencidos.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            DataGridViewCellStyle6.Alignment = DataGridViewContentAlignment.MiddleLeft;
            DataGridViewCellStyle6.BackColor = Color.FromArgb(191, 219, 255);
            DataGridViewCellStyle6.Font = new Font("Segoe UI", 8.25f);
            DataGridViewCellStyle6.ForeColor = Color.Black;
            DataGridViewCellStyle6.SelectionBackColor = SystemColors.Highlight;
            DataGridViewCellStyle6.SelectionForeColor = SystemColors.HighlightText;
            DataGridViewCellStyle6.WrapMode = DataGridViewTriState.False;
            dtVencidos.DefaultCellStyle = DataGridViewCellStyle6;
            ...
            KeyDown += new KeyEventHandler(PromPago_KeyDown);
            ResumeLayout(false);
