...
namespace ConfiaAdmin
{
    ...
    public partial class PromPagoBuenFin
    {
...
(select * from Empleados where Tipo = 'P') Promotores on Cartera.IdPromotor = Promotores.id ) CarteraTotal order by nombre asc";
            ...
            descuentoParcial = multasParcial * 0.9d;
...
(select * from Empleados where Tipo = 'P') Promotores on Cartera.IdPromotor = Promotores.id ) CarteraTotal order by nombre asc";
            ...
            descuentoTotal = multasTotal * 0.9d;
            ...
            lblDescuentoTotal.Text = descuentoTotal.ToString();
        ...
        private void BackgroundCrearPromesa_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (CheckVencidos.CheckState == CheckState.Checked)
            {
                consultaCrearPromesa = "insert into PromesaDePago values('" + idCredito + "','" + totalParcial + "','" + pagonormalParcial + "','" + multasParcial + "','" + totalParcial + "',0,'" + dateFechaLimite.Value.ToString("yyyy-MM-dd") + "','','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("HH:mm:ss") + "','" + Module1.nmusr + "','A','" + estadoCredito + "','" + totalParcial + "','" + descuentoParcial + "',0) SELECT SCOPE_IDENTITY()";
            }
            else
            {
                consultaCrearPromesa = "insert into PromesaDePago values('" + idCredito + "','" + TotalTotal + "','" + pagoNormalTotal + "','" + multasTotal + "','" + TotalTotal + "',0,'" + dateFechaLimite.Value.ToString("yyyy-MM-dd") + "','','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("HH:mm:ss") + "','" + Module1.nmusr + "','A','" + estadoCredito + "','" + TotalTotal + "','" + descuentoTotal + "',0) SELECT SCOPE_IDENTITY()";
            }
...
";
        ...
        private void BackgroundPromesaNotificacion_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (CheckVencidos.CheckState == CheckState.Checked)
            {
                consultaCrearPromesa = "insert into PromesaDePago values('" + idCredito + "','" + totalParcial + "','" + pagonormalParcial + "','" + multasParcial + "','" + totalParcial + "',0,'" + dateFechaLimite.Value.ToString("yyyy-MM-dd") + "','','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("HH:mm:ss") + "','" + Module1.nmusr + "','E','" + estadoCredito + "','" + totalParcial + "','" + descuentoParcial + "',0) SELECT SCOPE_IDENTITY()";
            }
            else
            {
                consultaCrearPromesa = "insert into PromesaDePago values('" + idCredito + "','" + TotalTotal + "','" + pagoNormalTotal + "','" + multasTotal + "','" + TotalTotal + "',0,'" + dateFechaLimite.Value.ToString("yyyy-MM-dd") + "','','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("HH:mm:ss") + "','" + Module1.nmusr + "','E','" + estadoCredito + "','" + TotalTotal + "','" + descuentoTotal + "',0) SELECT SCOPE_IDENTITY()";
            }
        ...
        {
            ncargando.Close();
            My.MyProject.Forms.CrearNotificacionDescuentoBuenFin.idPromesa = idPromesa;
            My.MyProject.Forms.CrearNotificacionDescuentoBuenFin.tipoCredito = TipoCredito;
            My.MyProject.Forms.CrearNotificacionDescuentoBuenFin.ShowDialog();
