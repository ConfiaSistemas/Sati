...
namespace ConfiaAdmin
{
    ...
    public partial class CalendarioReestructura
    {
        ...
        private void BackgroundConvenio_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            int idConvenio;
            consultaConvenio = "insert into ReestructurasSac values('" + idCredito + "','" + cantPagos + "','" + Moratorios + "','" + Capital + "','" + deudaTotal + "','" + pagoprimero + "','" + ultimopago + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + gestor + "','A') select SCOPE_IDENTITY()";
            ...
            foreach (DataGridViewRow row in dtimpuestos.Rows)
            {
                ...
                consultaCalendario = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("Insert into calendarioReestructurasSac values('" + numero + "','", row.Cells[2].Value), "','"), row.Cells[1].Value), "','0','"), row.Cells[0].Value), "','','"), idConvenio), "','P','"), row.Cells[3].Value), "','"), row.Cells[3].Value), "','0')"));
            ...
            consultaActCreditoLegal = "update credito set estado = 'R' where id = '" + idCredito + "'";
        ...
        {
            My.MyProject.Forms.Autorizacion.tipoAutorizacion = "SatiModCreditosCrearReestructura";
            My.MyProject.Forms.Autorizacion.ShowDialog();
            if (Autorizado)
            {
                My.MyProject.Forms.Cargando.Show();
                My.MyProject.Forms.Cargando.MonoFlat_Label1.Text = "Generando Reestructura";
