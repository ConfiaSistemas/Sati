...
#Region " EventArgs "
        ...
        Private Sub _OnKeyDown(ByVal Obj As Object, ByVal e As KeyEventArgs)
            ...
            '  e.SuppressKeyPress = True
            'End If
            If MyBase.Name = "txtcontra" Then
                If e.KeyCode = Keys.Enter Then


                    If FindForm.Name = "login" Then
                        If login.bloqueado Then
                            login.passwordBloqueadoAsync()
                        Else
                            login.passwordInicioAsync()
                        End If

                    ElseIf FindForm.Name = "Autorizacion" Then
                        Autorizacion.FlowEspere.Visible = True
                        Autorizacion.txtusr.Enabled = False
                        Autorizacion.txtcontra.Enabled = False
                        Autorizacion.MonoFlat_Button1.Enabled = False
                        Autorizacion.MonoFlat_Button2.Enabled = False
                        Autorizacion.BackgroundWorker1.RunWorkerAsync()
                    ElseIf FindForm.Name = "AutorizacionRetiro" Then
                        AutorizacionRetiro.FlowEspere.Visible = True
                        AutorizacionRetiro.txtusr.Enabled = False
                        AutorizacionRetiro.txtcontra.Enabled = False
