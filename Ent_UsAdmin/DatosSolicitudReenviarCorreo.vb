...
Public Class DatosSolicitudReenviarCorreo
    ...
    Private Sub btn_a_verificacion_Click(sender As Object, e As EventArgs)
        Cargando.Show()
    ...
    Private Sub btn_rechazar_Click(sender As Object, e As EventArgs)
        Cargando.Show()
            ...
            For Each row As DataGridViewRow In dtdatos.Rows
                ...
                For Each rowDocumento As DataRow In dataDocumentosCorreo.Rows
                    If rowDocumento("IdDatosSolicitud").ToString = row.Cells(0).Value Then
                        ...
                        If File.Exists("C:\ConfiaAdmin\SATI\TempPhotos\" & rowDocumento("nombre") & " " & row.Cells(2).Value & ".jpg") Then
                            numero += 1
                            bitmapDocumento.Save("C:\ConfiaAdmin\SATI\TempPhotos\" & rowDocumento("nombre") & " " & numero & " " & row.Cells(2).Value & ".jpg")
                            correo.Attachments.Add(New Net.Mail.Attachment("C:\ConfiaAdmin\SATI\TempPhotos\" & rowDocumento("nombre") & " " & numero & " " & row.Cells(2).Value & ".jpg"))
